...
public class Player {
    ...
    // 19.Kg1 Ne2+ 20.Kf1 Nxd4+ 21.Kg1 Ne2+ 22.Kf1 Nc3+ 23.Kg1 axb6 24.Qb4 Ra4 25.Qxb6 Nxd1 26.h3 Rxa2
    // 27.Kh2 Nxf2 28.Re1 Rxe1 29.Qd8+ Bf8 30.Nxe1 Bd5 31.Nf3 Ne4 32.Qb8 b5 33.h4 h5 34.Ne5 Kg7 35.Kg1 Bc5+
    ...
    public boolean movePieceWithAlgebraicNotation(ChessBoard chessBoard, String playerMove){
        Pattern genericAlgebraicNotationPattern = Pattern.compile("^(O-O(-O)?|[KQRBN]?[a-h]?[1-8]?x?[a-h][1-8](=[QRBN])?[+#]?)$");
        Matcher matcher = genericAlgebraicNotationPattern.matcher(playerMove);
        if(!matcher.matches()){
